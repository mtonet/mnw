...
<body>
	<div class="container">    	
        ...
        <div class="destaque">
            ...
            <h1><b>Destaque</b> do mês</h1>
            <p>Nosso mais recente case de sucesso!</p>
            <p class="nome-destaque">Jägermeister</p>
            <a target="_blank" href="http://www.facebook.com/jagermeisterbrasil"><img src="img/bt-destaque.jpg"></a>
            </div>
        </div><!--Fim destaque-->
        <div class="outros">
